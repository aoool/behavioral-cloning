...
I have collected in total 117630 images with corresponding steering angles and augmented this data by
flipping each image to prevent left or right biases in angles. I got 235260 images data set in total.
...
It was also able to drive around track 2 semiautonomous with a few manual interventions. 

On my machine (Lenovo T430s) model can drive with the maximum speed of 20 mph around the track 1 
and with 6 mph around the track 2. My laptop is not able to generate steering angles with the needed frequency on the higher speeds.
...
To capture good driving behavior, I recorded laps on tracks 1 and 2 using center lane driving. Then I recorded the vehicle 
